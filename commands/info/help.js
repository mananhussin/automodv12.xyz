...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            embed.setDescription(`**[invite](https://discordapp.com/oauth2/authorize?client_id=744597377406599188&scope=bot&permissions=2088234238)** **[Support](https://discord.gg/j3m3jP5)** **[voteme](https://www.paradisebots.net/bots/744597377406599188) **[status](https://automod-v12-status-.glitch.me/)** **These Are the Available Commands For ${message.guild.me.displayName}\nBot's Global Prefix Is \`${PREFIX}\`\nServer Prefix Is \`${prefix}\`\n\nFor Help Related To A Particular Command Type -\n\`${prefix}help [command name | alias]\`**`)
